...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.ce52aa03dc7bb935a8bf8500356d9f28f5c0d55cbb0db00fc8a792e265d07f17.js',function(){input.required=false;search();});}
